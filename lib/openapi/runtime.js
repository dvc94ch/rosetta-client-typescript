            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, RestClientUtils.getErrorFromFetchResponse(response)];
 ...
 */
var RestClientCallError = /** @class */ (function (_super) {
    __extends(RestClientCallError, _super);
    function RestClientCallError(message, statusCode, statusMessage, body) {
    ...
    return RestClientCallError;
}(Error));
exports.RestClientCallError = RestClientCallError;
var RestClientUtils = /** @class */ (function () {
    function RestClientUtils() {
    }
    RestClientUtils.getErrorFromFetchResponse = function (error) {
        return __awaiter(this, void 0, void 0, function () {
            var statusCode, statusMessage, body, getMessage, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        statusCode = (error === null || error === void 0 ? void 0 : error.status) || 0;
                        statusMessage = ((error === null || error === void 0 ? void 0 : error.statusText) || 'Unknown Error').toString();
                        return [4 /*yield*/, error.text()];
                    case 1:
                        body = _a.sent();
                        getMessage = function () {
                            var defaultMessage = "".concat(statusCode, " - ").concat(statusMessage);
                            try {
                                var modelError = (0, models_1.ModelErrorFromJSON)(JSON.parse(body));
                        ...
                        message = getMessage();
                        return [2 /*return*/, new RestClientCallError(message, statusCode, statusMessage, body)];
                }
            });
        });
    };
