...
function AllowFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        balance_exemptions: !(0, runtime_1.exists)(json, 'balance_exemptions')
            ? undefined
            : json['balance_exemptions'].map(_1.BalanceExemptionFromJSON),
...
function AllowToJSON(value) {
    ...
    return {
        ...
        balance_exemptions: value.balance_exemptions === undefined ? undefined : value.balance_exemptions.map(_1.BalanceExemptionToJSON),
