 ...
 *
 */
export declare class ConstructionApi extends runtime.BaseAPI {
    /**
     ...
     * Create Network Transaction from Signatures
     */
    constructionCombine(constructionCombineRequest: ConstructionCombineRequest, initOverrides?: RequestInit): Promise<ConstructionCombineResponse>;
    /**
     ...
     * Derive an AccountIdentifier from a PublicKey
     */
    constructionDerive(constructionDeriveRequest: ConstructionDeriveRequest, initOverrides?: RequestInit): Promise<ConstructionDeriveResponse>;
    /**
     ...
     * Get the Hash of a Signed Transaction
     */
    constructionHash(constructionHashRequest: ConstructionHashRequest, initOverrides?: RequestInit): Promise<TransactionIdentifierResponse>;
    /**
     ...
     * Get Metadata for Transaction Construction
     */
    constructionMetadata(constructionMetadataRequest: ConstructionMetadataRequest, initOverrides?: RequestInit): Promise<ConstructionMetadataResponse>;
    /**
     ...
     * Parse a Transaction
     */
    constructionParse(constructionParseRequest: ConstructionParseRequest, initOverrides?: RequestInit): Promise<ConstructionParseResponse>;
    /**
     ...
     * Generate an Unsigned Transaction and Signing Payloads
     */
    constructionPayloads(constructionPayloadsRequest: ConstructionPayloadsRequest, initOverrides?: RequestInit): Promise<ConstructionPayloadsResponse>;
    /**
     ...
     * Create a Request to Fetch Metadata
     */
    constructionPreprocess(constructionPreprocessRequest: ConstructionPreprocessRequest, initOverrides?: RequestInit): Promise<ConstructionPreprocessResponse>;
    /**
     ...
     * Submit a Signed Transaction
     */
    constructionSubmit(constructionSubmitRequest: ConstructionSubmitRequest, initOverrides?: RequestInit): Promise<TransactionIdentifierResponse>;
}
