...
var CallApi = /** @class */ (function (_super) {
     ...
     */
    CallApi.prototype.callRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.CallResponseFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Make a Network-Specific Procedure Call
     */
    CallApi.prototype.call = function (callRequest, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.callRaw({ callRequest: callRequest }, initOverrides)];
                    case 1:
                        response = _a.sent();
