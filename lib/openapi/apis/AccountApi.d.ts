...
export declare class AccountApi extends runtime.BaseAPI {
     ...
     * Get an Account\'s Balance
     */
    accountBalance(accountBalanceRequest: AccountBalanceRequest, initOverrides?: RequestInit): Promise<AccountBalanceResponse>;
    /**
     ...
     * Get an Account\'s Unspent Coins
     */
    accountCoins(accountCoinsRequest: AccountCoinsRequest, initOverrides?: RequestInit): Promise<AccountCoinsResponse>;
}
