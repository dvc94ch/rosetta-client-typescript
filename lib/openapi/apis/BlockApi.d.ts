...
export declare class BlockApi extends runtime.BaseAPI {
     ...
     * Get a Block
     */
    block(blockRequest: BlockRequest, initOverrides?: RequestInit): Promise<BlockResponse>;
    /**
     ...
     * Get a Block Transaction
     */
    blockTransaction(blockTransactionRequest: BlockTransactionRequest, initOverrides?: RequestInit): Promise<BlockTransactionResponse>;
}
